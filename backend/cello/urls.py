...
from cello.views.exercise_request import EditExerciseRequestView
...
urlpatterns = [
    ...
    path('requested/approve/<int:request_id>', EditExerciseRequestView.as_view({'get': 'retrieve'}), name='approve-edit-exercise-request'),
    path('requested/reject/<int:request_id>', EditExerciseRequestView.as_view({'get': 'retrieve'}), name='reject-edit-exercise-request')
]
